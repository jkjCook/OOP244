...
namespace sict{
    ...
    String::String(const char* pSource){
       strncpy(this->m_pString, pSource, 50);
    }
    ...
    {
       strncpy(this->m_pString, other, STRING_BUFFERSIZE);
    }
    ...
    {
       return (strcmp(this->m_pString, "\0") == 0 ? false : true);
    }
    ...
    {
       return (strcmp(this->m_pString, s2) == 0 ? true : false);
    }
